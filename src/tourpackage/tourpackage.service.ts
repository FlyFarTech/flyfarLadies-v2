...
async findOne(Id: number) {
  ...
  //   const tourPackages = await this.TourpackageRepo.createQueryBuilder("tourPackage")
  //     .select([
  //       "tourPackage.Id",
  ...
  //     .andWhere(
  //       new Brackets((qb) => {
  //         qb.where("tourPackage.City = :City", { City }).orWhere("tourPackage.Country = :Country", { Country });
  //       })
  //     )
